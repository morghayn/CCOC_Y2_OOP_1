...
void ProgFunc::Draw(int style, int col, int row, int length,int amount) {
...
void ProgFunc::gotoXY(int x, int y) {
	CursorPosition.X = x; CursorPosition.Y = y;
	SetConsoleCursorPosition(myConsole,CursorPosition);
}

void ProgFunc::gotoXY(int x, int y, string text, bool highlight) {
	CursorPosition.X = x; CursorPosition.Y = y;
	SetConsoleCursorPosition(myConsole,CursorPosition);
...
void ProgFunc::ShowConsoleCursor(bool showFlag)
{
